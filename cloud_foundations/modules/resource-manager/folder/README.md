...
- The namespace property of the null-label module is fixed to `fo`
...
module "folder" {
  ...
  parent  = "organizations/132905988165"
}
```
By default, the null-label module will use the prefix `fo`, resulting in folder name `fo-data-engineering`.

```hcl
# module.folder.google_folder.folder will be created
  + resource "google_folder" "folder" {
      + create_time     = (known after apply)
      + display_name    = "fo-data-engineering"
      + folder_id       = (known after apply)
      + id              = (known after apply)
      + lifecycle_state = (known after apply)
      + name            = (known after apply)
      + parent          = "organizations/32905988165"
    }
```
...
By setting the label_order to not include `namespace`, the default `fo` prefix is not used and the resulting folder will
be named `eu-dev-anthos-engineering`.

```hcl
  # module.folder.google_folder.folder will be created
+ resource "google_folder" "folder" {
+ create_time     = (known after apply)
+ display_name    = "eu-dev-anthos-engineering"
+ folder_id       = (known after apply)
+ id              = (known after apply)
+ lifecycle_state = (known after apply)
+ name            = (known after apply)
...
# TODO
- Extend to use labels. For this, use the `tags` and/or `additional_tag_map` of the null-label module.
...
| <a name="input_parent"></a> [parent](#input\_parent) | The parent ID of the org or folder under which this folder must be created as a direct descendant. format: organizations/1234567 or folders/1234567 | `string` | `null` | no |
...
| <a name="output_folder_parent_id"></a> [folder\_parent\_id](#output\_folder\_parent\_id) | n/a |
